...
//for usamos quando sabemos o tanto de iterações serão necessárias.... while não sabemos quantas iterações serão necesárias
...
while (contador < 1000){
    contador++
    const moeda = (Math.floor(Math.random()*2))
    if ( moeda == 1){
        cara++
    }
    else{
